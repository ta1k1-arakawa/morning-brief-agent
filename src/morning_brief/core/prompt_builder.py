    ...
    def _build_output_rules_section(self) -> str:
        ...
        return "\n".join(
            [
                ...
                "- 前置きやまとめを書かず、次の4見出しだけを使う",
                "- 見出しの順番は変えない",
                "## 今日の予定",
                "- Calendarにある今日の予定だけを時刻順に箇条書きする",
                "## 今日絶対やること",
                "- Todoistとメールから、今日必要な行動を書く",
                "## 今日できたらやること",
                "- Todoistとメールから、余裕があれば行うものを書く",
                "- 2つの『やること』にCalendarの予定を入れない",
                "- Calendarの予定から新しいタスクを推測しない",
                "- 各項目は1行の箇条書きにする",
                "- 該当する項目がない見出しには『- なし』と書く",
                "## 注意点",
                "- 注意点を簡潔に書く",
            ]
        )
